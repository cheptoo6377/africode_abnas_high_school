...
class PermitType(db.Model):                                                   
  ...
  nullable=False)                                                                 
        ...
        # Relationships                                                           
        applications = db.relationship('PermitApplication', backref='permit_type',
  lazy='dynamic')                                                                 
...
class PermitApplication(db.Model):                                            
        ...
        permit_type_id = db.Column(db.Integer, db.ForeignKey('permit_types.id'),  
  nullable=False)                                                                 
        department_id = db.Column(db.Integer, db.ForeignKey('departments.id'),    
  nullable=False)                                                                 
  ...
  backref='permit_applications')                                                  
        assigned_officer = db.relationship('User',                                
  foreign_keys=[assigned_officer_id], backref='assigned_permits')                 
        ...
        documents = db.relationship('PermitDocument', backref='application',      
...
def is_overdue(self):                                                     
            ...
            if self.permit_type.processing_days and self.status not in ['Approved',
  'Rejected']:                                                                    
