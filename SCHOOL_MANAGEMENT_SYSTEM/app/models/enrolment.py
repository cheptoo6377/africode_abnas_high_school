...
class EnrolmentModel(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)  # Fixed typo: Interger -> Integer
    student_id = db.Column(db.Integer, db.ForeignKey('students.id'), nullable=False)  # Fixed typo: Interger -> Integer
